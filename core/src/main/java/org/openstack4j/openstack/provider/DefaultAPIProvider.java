...
public class DefaultAPIProvider implements APIProvider {
	...
	public void initialize() {
		...
		bind(LBaaSService.class, LBaaSServiceImpl.class);
		bind(LbLoadBalancerV2Service.class, LbLoadBalancerV2ServiceImpl.class);
		bind(LbListenerV2Service.class, LbListenerV2ServiceImpl.class);
		bind(LbPoolV2Service.class, LbPoolV2ServiceImpl.class);
		bind(LbMemberV2Service.class, LbMemberV2ServiceImpl.class);
